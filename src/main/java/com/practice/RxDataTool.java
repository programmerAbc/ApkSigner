...
import static com.practice.RxConstTool.BYTE;
import static com.practice.RxConstTool.GB;
import static com.practice.RxConstTool.KB;
import static com.practice.RxConstTool.MB;
...
public class RxDataTool {
    ...
    public static String byte2FitSizeShortString(long byteNum) {
        if (byteNum < 0) {
            return "shouldn't be less than zero!";
        } else if (byteNum < KB) {
